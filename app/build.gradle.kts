...
val appVersionCode = providers.gradleProperty("appVersionCode").map(String::toInt).orElse(4009)
val appVersionName = providers.gradleProperty("appVersionName").orElse("0.4.9")
