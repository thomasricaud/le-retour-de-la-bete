...
val appVersionCode = providers.gradleProperty("appVersionCode").map(String::toInt).orElse(4004)
val appVersionName = providers.gradleProperty("appVersionName").orElse("0.4.4")
